...
[
    '999',
    $empid,
    "Leave Request Approved for your $ltype on date - $formattedleavedate",
    $time, 
    '0', 
    'UNREAD',
    'N' 
...
$sql = "INSERT INTO leave (empid, compodate, leavedate, reason, leavetype, action) 
        VALUES (?, ?, ?, ?, ?, ?)";
$params = array($empid, $compodate1, $leavedate, $reason, $leavetype, $action);
