...
<body class="report" bottommargin="0" topmargin="0" leftmargin="0" rightmargin="0" style="background-color: #edb984;caret-color:transparent;">
  ...
  <div id="loader">
    <img src="../leave/images/MEFS.png" alt="Loading..." class="logo">
  </div>
...
<aside class="sidebar" id="sidebar">
    ...
    <ul class="sidebar-links" id="main-content">
        <h4>
            <span>Main Menu</span>
            <div class="menu-separator"></div>
        </h4>
...
<aside class="sidebar1" id="sidebar1">
    <div class="sidebar1-header" id="main-content">
...
<div class="header">
    ...
    <b style="font-size:20px;align-items:center;margin-left:460px;font-weight: bold;">MIDDLE EAST FINANCIAL SOFTWARE SOLUTIONS &nbsp;</b>
...
if (count($names) > 1) 
{
	foreach ($names as $index => $nameList) 
	{
		...
		if (strlen($currentMessage) > 25) 
		{
			$truncatedMessage = substr($currentMessage, 0, 25);
...
@media screen and (max-width: 768px) 
{
    ...
    <ul class="sidebar1-links"  id="main-content">
...
{
//echo "<center><br><br><br><br>Current time: " . date('Y-m-d H:i:s', time());
$totalLeaveBalance1='';
...
@media screen and (max-width: 768px) 
{
    ...
    <ul class="sidebar3-links"  id="main-content">
...
<aside class="sidebar2" id="sidebar2">
    ...
    <ul class="sidebar2-links" id="main-content">
        <h4>
            <span>Main Menu</span>
            <div class="menu-separator"></div>
        </h4>
