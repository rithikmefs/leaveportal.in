...
if($empid)
{
	...
	$sql3 = "select empid,leavedate,leavetype,reason from [MISGlobal].[dbo].[leave] with (nolock) where empid='$empid' AND action = 'A' order by leavedate desc";
	...
	while($row3 = sqlsrv_fetch_array( $res3, SQLSRV_FETCH_ASSOC))
	{
		...
		$sql5 = "select compodate from leave with (nolock) where empid='$empid' and leavetype='COMPO' and leavedate='$leavedate' AND action = 'A'";
...
?>	
	...
	<div id="table-container">
		...
		<td align=center style='background-color:#665763;color:white;font-family:Poppins;width:50px;'>SL NO</td>
		<td align=center style='background-color:#665763;color:white;font-family:Poppins;width:145px;'>LEAVE TAKEN DATES</td>
		<td align=center style='background-color:#665763;color:white;font-family:Poppins;width:80px;'>LEAVE TYPE</td>
		<td align=center style='background-color:#665763;color:white;font-family:Poppins;width:180px;'>REASON FOR LEAVE</td>
		</tr>
	...
	$sq="select count(leavetype) as casualcount from leave where leavetype='CASUAL' and empid='$empid' AND action = 'A'";
	...
	$sqll="select count(leavetype) as compocount from leave where leavetype='COMPO' and empid='$empid' AND action = 'A'";
	...
	if($cutoff>0)
	{	
		echo "<b style='font-size:20px;font-family:Poppins;margin-left:525px;'>Salary Cut Leave Count : </b><b style='color:black;font-size:20px;'>".$cutoff."</b>";
		echo "<br><b style='font-size:28px;font-family:Poppins;margin-left:475px;'>Current Leave Balance : </b><b style='$color1 font-size:30px;'>".$plus."".$totalLeaveBalance1."</b>";
		echo "<br><b style='font-size:28px;font-family:Poppins;margin-left:485px;'>Compo Leave Balance : </b><b style='$col font-size:30px;'>".$compoleave."</b><br>";		
	}
	else
	{
		echo "<b style='font-size:28px;font-family:Poppins;margin-left:475px;'>Current Leave Balance : </b><b style='$color1 font-size:30px;'>".$plus."".$totalLeaveBalance1."</b>";
		echo "<br><b style='font-size:28px;font-family:Poppins;margin-left:485px;'>Compo Leave Balance : </b><b style='$col font-size:30px;'>".$compoleave."</b><br>";		
	}	
