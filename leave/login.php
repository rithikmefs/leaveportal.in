...
<center>
    ...
    <div class="form_container">
      ...
      <form action="login.php" method="post">
		...
		<div class='forgot'>
		<a href="javascript:NewWindow('forgotpassword.php');window.focus();" style="color: black;"><p style='font-size:15px;color:grey;font-family:poppins;'>Forgot Password?</p></a>
		</div>
...
{
    window.open(url, 'newx', 'width=620,height=420,left=60,top=20,resizable=1,scrollbars=yes,toolbar=no,directories=no,menubar=0,location=0,status=0');
}
